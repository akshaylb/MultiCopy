...
public class WorkingDayMovement extends ExtendedMovementModel {
	...
	/**
	 * @return The location of all offices
	 * Author: Akshay Kayastha, Khushveer Kaur, Dilip Yadav
	 */
	public List<Coord> getAllOfficeLocations() {
		return workerMM.getAllOfficeLocations();
	}
	...
	/**
	 * @return The location of all meeting spots
	 * Author: Akshay Kayastha, Khushveer Kaur, Dilip Yadav
	 */
	public List<Coord> getAllShoppingLocations() {
		return eveningActivityMovement.getAllShoppingLocations();
	}
}
